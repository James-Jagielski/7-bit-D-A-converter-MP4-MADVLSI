...
N 180 -40 260 -40 {
lab=D1}
C {devices/opin.sym} 550 120 0 0 {name=p4 lab=Iout}
...
C {/home/madvlsi/dev/git/7-bit-D-A-converter-MP4-MADVLSI/Final DAC files/schematics/DAC/MP4_DAC.sym} 530 60 0 0 {name=x9}
C {devices/opin.sym} 550 150 0 0 {name=p12 lab=Iref}
C {devices/lab_pin.sym} 480 -120 1 0 {name=p3 sig_type=std_logic lab=VDD}
C {devices/ipin.sym} 450 -120 1 0 {name=p30 lab=Vg}
