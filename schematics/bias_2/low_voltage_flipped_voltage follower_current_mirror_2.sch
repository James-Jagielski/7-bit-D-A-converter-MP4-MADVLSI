...
C {madvlsi/isource.sym} -120 80 2 0 {name=Iin
value=30n}
...
C {madvlsi/nmos3.sym} -60 -130 0 0 {name=M7
L=0.5
W=12
body=GND
nf=1
...
C {madvlsi/nmos3.sym} 70 -40 0 1 {name=M14
L=0.5
W=12
body=GND
nf=1
...
C {madvlsi/vdd.sym} 70 -70 0 0 {name=l5 lab=VDD}
