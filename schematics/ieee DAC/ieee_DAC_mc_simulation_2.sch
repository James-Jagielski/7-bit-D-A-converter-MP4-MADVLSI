...
dowhile run <= mc_runs
  ...
  while code < 128
    ...
    wrdata ~/dev/git/7-bit-D-A-converter-MP4-MADVLSI/schematics/simulations/ieee_DAC/dac_with_external_bias_gen/test_12/ieeeDAC_\{$&run\}.txt V0 V1 V2 V3 V4 V5 V6 v(Vb) i(Vib) i(Viout)
    if code eq 0
      set appendwrite
...
value=0.55}
C {madvlsi/gnd.sym} 350 -420 0 0 {name=l2 lab=GND}
