...
C {devices/lab_pin.sym} 200 -240 1 0 {name=p6 sig_type=std_logic lab=Vi2}
C {/home/madvlsi/dev/git/7-bit-D-A-converter-MP4-MADVLSI/schematics/ieee DAC/ieee_simple_dac_differential_output.sym} 120 -330 0 0 {name=x1}
C {madvlsi/vdd.sym} 120 -400 0 0 {name=l1 lab=VDD}
C {madvlsi/ammeter2.sym} 140 -440 0 0 {name=Vib}
C {madvlsi/pmos3.sym} 140 -480 0 0 {name=M2
L=3
W=12
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 140 -670 0 0 {name=M4
L=3
W=12
body=VDD
nf=1
...
C {devices/lab_pin.sym} 60 -340 0 0 {name=p7 sig_type=std_logic lab=V1}
C {devices/lab_pin.sym} 60 -320 0 0 {name=p8 sig_type=std_logic lab=V2}
C {devices/lab_pin.sym} 60 -300 0 0 {name=p9 sig_type=std_logic lab=V3}
C {devices/lab_pin.sym} 60 -280 0 0 {name=p17 sig_type=std_logic lab=V4}
C {devices/lab_pin.sym} 60 -260 0 0 {name=p21 sig_type=std_logic lab=V5}
C {devices/lab_pin.sym} 60 -240 0 0 {name=p22 sig_type=std_logic lab=V6}
C {devices/lab_pin.sym} 60 -360 0 0 {name=p23 sig_type=std_logic lab=V0}
C {madvlsi/gnd.sym} 120 -200 0 0 {name=l3 lab=GND}
